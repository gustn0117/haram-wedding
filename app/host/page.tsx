    ...
    <main>
      ...
      <section className="py-24 md:py-32 bg-haram-dark text-center px-6 relative overflow-hidden">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeScale}
          ...
          <div className="text-[48px] font-serif text-haram-gold/20 leading-none mb-6">&ldquo;</div>
          <p className="text-[22px] md:text-[34px] font-serif text-white/80 font-light leading-[1.7]">
            결혼식의 품격은 목소리에서 시작됩니다.
          </p>
          <div className="w-12 h-[1px] bg-haram-gold/30 mx-auto mt-10" />
        </motion.div>
      </section>
      ...
      <section className="py-28 md:py-40 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0.1} variants={fadeScale}
            className="bg-haram-cream p-9 md:p-14 border border-gray-100 corner-deco">
