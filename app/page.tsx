  ...
  return (
    <main>
      ...
      <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden bg-haram-dark">
        ...
        <div className="absolute bottom-28 right-8 md:right-16 w-20 h-20 border-r border-b border-white/[0.08]" />
        ...
        <motion.div className="relative z-10 text-center text-white px-6 max-w-4xl" style={{ opacity: heroOpacity }}>
          ...
          <motion.h1 initial="hidden" animate="visible" custom={0.15} variants={fade}
            className="text-[56px] md:text-[88px] lg:text-[110px] font-serif font-medium tracking-[0.12em] leading-[1] mb-4">
            HARAM
          </motion.h1>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-center">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fade}
              ...
              <h2 className="text-[32px] md:text-[44px] font-serif font-light text-haram-dark leading-[1.3] mb-6">
                결혼식다운
                <br />
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0.15} variants={fade}
              ...
              <p className="text-[16px] md:text-[18px] leading-[2.2] text-gray-500 mb-10 font-light">
                ...
                화려함보다는 안정감, 연출보다는 정돈된 분위기를 추구합니다.
              </p>
      ...
      <section id="services" className="py-28 md:py-40 px-6 bg-haram-cream relative">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              { href: '/photobooth', img: 'https://framerusercontent.com/images/6N1mDmTXg1MfQTQiGpBPeqSqE40.png', title: '포토부스', sub: 'Photobooth', desc: '하객에게 추억을, 부부에게 감동을 선물하는 프리미엄 포토부스' },
              { href: '/host', img: 'https://framerusercontent.com/images/QymrN1DNcUPDOCnpsHJcitDswrk.png', title: '전문사회', sub: 'Host', desc: '격식과 감동 사이의 완벽한 균형을 잡는 전문 MC' },
              { href: '/concierge', img: 'https://framerusercontent.com/images/nWAdkvqfbxvcttAg2x2PWOqDosI.png', title: '컨시어지', sub: 'Concierge', desc: '예식 현장의 모든 흐름을 조율하는 전문 매니저 파견' },
            ].map((card, i) => (
                ...
                <Link href={card.href} className="block group img-overlay-zoom">
                  <div className="relative aspect-[3/4] overflow-hidden bg-gray-100">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-7 md:p-8 text-white">
                      ...
                      <div className="w-6 h-[1px] bg-haram-gold/50 mb-4 group-hover:w-12 transition-all duration-500" />
      ...
      <section className="py-28 md:py-40 px-6">
        <div className="max-w-5xl mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fade}
            ...
            <p className="section-label section-label-center justify-center mb-6">Why Haram</p>
      ...
      <section className="relative h-[55vh] md:h-[65vh] overflow-hidden flex items-center justify-center">
        <div className="absolute inset-0">
          <Image src="https://framerusercontent.com/images/qrDW2av5Tu0YgzisKviZ93qgpE.png"
        ...
        <div className="absolute top-10 left-10 md:top-16 md:left-16 w-20 h-20 border-l border-t border-white/[0.08]" />
        <div className="absolute bottom-10 right-10 md:bottom-16 md:right-16 w-20 h-20 border-r border-b border-white/[0.08]" />
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeScale}
          ...
          <div className="text-[48px] font-serif text-haram-gold/25 leading-none mb-6">&ldquo;</div>
          <p className="text-[22px] md:text-[32px] font-serif leading-[1.8] font-light">
            하객의 첫인상은 공간이 아니라,
            <br />사람이 만듭니다.
          </p>
          <div className="w-12 h-[1px] bg-haram-gold/40 mx-auto mt-10" />
        </motion.div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            {[
              ...
              <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }}
                ...
                <p className="text-[42px] md:text-[56px] font-serif font-light text-white leading-none mb-4 tracking-wide">
                  {stat.num}
                </p>
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }}
                custom={i * 0.1} variants={fade}
                className="bg-white p-8 border border-gray-100 text-center card-hover group">
                <p className="text-[40px] font-serif font-light text-haram-gold/20 mb-5 group-hover:text-haram-gold/40 transition-colors duration-500">{item.step}</p>
      ...
      <section className="py-32 md:py-44 px-6 bg-haram-dark text-center relative overflow-hidden">
        ...
        <div className="absolute top-20 left-10 w-32 h-32 border border-haram-gold/[0.03] rounded-full" />
        <div className="absolute bottom-20 right-10 w-48 h-48 border border-haram-gold/[0.03] rounded-full" />

        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeScale}
          className="max-w-2xl mx-auto relative">
          <p className="section-label section-label-center justify-center text-haram-gold/40 mb-8">Contact</p>
          <h2 className="text-[30px] md:text-[44px] text-white leading-[1.5] mb-6 font-light">
            특별한 날, 하람과 함께하세요
          </h2>
          <p className="text-[14px] text-gray-500 mb-12 font-light">
            간단한 문의만으로도 맞춤 상담을 시작할 수 있습니다
          </p>
          <p className="text-[32px] md:text-[44px] font-serif font-light text-haram-gold mb-14 tracking-wider">
            010-7930-1332
          </p>
          <Link href="/contact" className="btn-primary">
            <span>문의하기</span>
