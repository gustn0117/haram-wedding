...
export default function PhotoboothPage() {
  return (
    <main>
      ...
      {/* STORY – editorial split with image */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-20 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeScale}
              ...
              <div className="relative aspect-[4/5] overflow-hidden">
                <Image src="https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&w=800&q=80"
                  alt="Wedding bouquet" fill className="object-cover" />
              </div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0.15} variants={fade}
              ...
              <p className="text-[18px] md:text-[22px] text-haram-dark leading-[1.7] font-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }}
                ...
                className="card-hover card-shine bg-white p-9 md:p-12 border border-gray-100 group relative overflow-hidden">
      ...
      <section className="py-28 md:py-40 px-6 bg-haram-cream relative">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeScale}
              className="bg-white p-9 md:p-12 border border-gray-100 card-hover relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-haram-gold/5 to-transparent" />
