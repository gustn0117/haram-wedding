    ...
    <main className="w-full">
      ...
      <section className="relative w-full h-[90vh] flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-4xl">
          <motion.p initial="hidden" animate="visible" custom={0} variants={fadeUp}
            className="text-[10px] tracking-[0.4em] text-haram-gold/90 mb-6 font-montserrat uppercase">Haram Photobooth</motion.p>
      ...
      <section className="relative py-36 px-6 bg-white overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp}>
            <p className="text-[10px] tracking-[0.35em] text-haram-gold mb-6 font-montserrat uppercase">Story</p>
            <h2 className="text-[28px] md:text-[38px] font-light text-gray-900 leading-[1.4] mb-10">
              사진은 남고, 감정은 오래갑니다
            </h2>
          ...
          <motion.p initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0.45} variants={fadeUp}
            className="text-[16px] md:text-[19px] leading-[2] text-gray-900 font-light">
      ...
      <section className="py-32 px-6 bg-[#fafaf7]">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp}>
            <p className="text-[10px] tracking-[0.35em] text-haram-gold mb-4 font-montserrat uppercase">Custom Template</p>
            <h2 className="text-[28px] md:text-[38px] font-light text-gray-900 mb-10">
              고객님을 위한 맞춤형 템플릿 제작
            </h2>
          </motion.div>
          <motion.p initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0.2} variants={fadeUp}
      ...
      <section className="relative py-32 px-6 bg-white overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp}>
            <h2 className="text-[28px] md:text-[38px] font-light text-gray-900 leading-[1.4] mb-8">
              기억은 흐려지지만
              <br />
      ...
      <section className="py-32 px-6 bg-[#fafaf7]">
        <div className="max-w-4xl mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp}
            ...
            <p className="text-[10px] tracking-[0.35em] text-haram-gold mb-4 font-montserrat uppercase">Process</p>
          ...
          {[
            ...
            <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }}
              ...
              className="flex gap-8 md:gap-14 py-10 border-b border-gray-200/60 group">
              <span className="text-[42px] font-light text-haram-gold/40 font-montserrat w-16 shrink-0
                group-hover:text-haram-gold/80 transition-colors duration-500">{item.step}</span>
              <div>
      ...
      <section className="py-32 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp}
            className="text-center mb-20">
            <p className="text-[10px] tracking-[0.35em] text-haram-gold mb-4 font-montserrat uppercase">Pricing</p>
            <h2 className="text-[28px] md:text-[38px] font-light text-gray-900">하람 포토부스 패키지</h2>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Main Package */}
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp}
              className="bg-[#fafaf7] p-10 md:p-12 rounded-2xl border border-gray-100 relative overflow-hidden">
              <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-haram-gold to-transparent" />
              <p className="text-[10px] tracking-[0.25em] text-haram-gold mb-2 font-montserrat uppercase">Standard</p>
              <h3 className="text-[18px] font-light text-gray-900 mb-8">하람 포토부스 패키지</h3>
              <p className="text-[44px] font-light text-gray-900 mb-1 font-montserrat">
                500,000<span className="text-[14px] text-gray-400 ml-1">원/1회</span>
              </p>
              ...
              <Link href="/contact"
                className="block mt-10 text-center bg-haram-gold text-white py-4 rounded-full text-[12px] tracking-[0.1em] uppercase font-montserrat
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0.15} variants={fadeUp}
              className="bg-[#fafaf7] p-10 md:p-12 rounded-2xl border border-gray-100">
              <p className="text-[10px] tracking-[0.25em] text-haram-gold mb-2 font-montserrat uppercase">Benefits</p>
              <h3 className="text-[18px] font-light text-gray-900 mb-3">혜택 프로그램 안내</h3>
              <p className="text-[13px] text-gray-400 font-light mb-8">보다 저렴하게 이용하세요!</p>
              <div className="gold-divider mb-8" />
              <ul className="space-y-5 text-[13px] text-gray-500 font-light">
                <li className="flex justify-between items-center pb-5 border-b border-gray-100">
                  <span>홍보 활용 동의시</span>
                  <span className="text-haram-gold font-montserrat text-[12px]">10% 할인 [-5만원]</span>
                </li>
                <li className="flex justify-between items-center pb-5 border-b border-gray-100">
                ...
                <li className="flex justify-between items-center pb-5 border-b border-gray-100">
                  ...
                  <span className="text-haram-gold font-montserrat text-[12px]">4% 할인 [-2만원]</span>
                </li>
      ...
      <section className="relative py-32 px-6 bg-[#fafaf7] overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp}>
            ...
            <p className="text-[13px] text-gray-400 font-light mb-12">
